...
3. Verify the build: `java -jar target/fc5-convert-cli-199-SNAPSHOT-runner.jar --help`


To run commands listed below, either: 

- Replace `fc5-convert` with `java -jar target/fc5-convert-cli-199-SNAPSHOT-runner.jar`
- Use JBang to create an alias that points to the built jar: 

    ```shell
    jbang app install --name fc5-convert --force --fresh ~/.m2/repository/dev/ebullient/fc5-convert-cli/199-SNAPSHOT-runner/fc5-convert-cli-199-SNAPSHOT--runner.jar
    ```
