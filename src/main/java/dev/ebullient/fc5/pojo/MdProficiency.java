...
public class MdProficiency {
    public static final MdProficiency NONE = new Builder().fromString("").build();

    final List<SkillOrAbility> skills;

    public MdProficiency(List<SkillOrAbility> skills) {
        this.skills = skills;
    }
    ...
    public static class Builder {
        ...
        public MdProficiency build() {
            return new MdProficiency(skills.stream().collect(Collectors.toList()));
        }
    }
}
