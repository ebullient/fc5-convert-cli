...
@TemplateData
public class MdSpell implements BaseType {
    ...
    public MdSpell(String name, int level, SchoolEnum school, boolean ritual, String time, String range,
    ...
    public static class Builder {
        ...
        public MdSpell build() {
            return new MdSpell(name, level, school, ritual, time, range, components, duration, classes, text);
        }
    }
}
