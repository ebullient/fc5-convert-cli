...
@TemplateData
public class MdItem implements BaseType {
    ...
    protected MdItem(String name, String detail, ItemEnum type, int ac,
    ...
    public static class Builder {
        ...
        public MdItem build() {
            ...
            return new MdItem(name, detail, type, ac, cost, weight,
    ...
    public static String createDetail(String attunement, ItemEnum type, List<PropertyEnum> properties) {
        ...
        PropertyEnum.tierProperties.forEach(p -> {
            if (properties.contains(p)) {
                replacement.append(", ").append(p.value());
            }
        });
        ...
        if (properties.contains(PropertyEnum.POISON)) {
            replacement.append(", ").append(PropertyEnum.POISON.value());
        }
        if (properties.contains(PropertyEnum.CURSED)) {
            replacement.append(", ").append(PropertyEnum.CURSED.value());
        }
