 ...
 */
@TemplateData
public class ItemType extends MdItem implements BaseType {
    final Text text;
    final List<Roll> roll;

    public ItemType(String name, String detail, ItemEnum type, int ac,
    ...
    static class ItemBuilder extends Builder {
        ...
        public ItemBuilder(ParsingContext context) {
            ...
            setDamage(context.getOrDefault("dmg1", Roll.NONE).toString(),
                    context.getOrDefault("dmg2", Roll.NONE).toString(),
                    context.getOrDefault("dmgType", DamageEnum.UNKNOWN).value());
        ...
        public ItemType build() {
            Text text = context.getOrDefault("text", Text.NONE);
            List<Roll> roll = context.getOrDefault("roll", Collections.emptyList());
            ...
            return new ItemType(name, detail, type, ac, cost, weight, strengthRequirement, stealthPenalty,
